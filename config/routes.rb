...
Rails.application.routes.draw do
  ...
  get 'architecture_selected_discovers' => 'hosts#architecture_selected'
  get 'os_selected_discovers'           => 'hosts#os_selected'
  get 'medium_selected_discovers'       => 'hosts#medium_selected'
